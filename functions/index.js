...
const SPOTS = [
  ...
  // ── Added 2026-05-22 — backfilling spots referenced by mock data
  // (ConditionsScreen / CommunityScreen / MyDivesScreen / ProfileScreen)
  // so spot-detail pages render live conditions instead of falling
  // back to per-name mock metrics.

  // Oahu north shore — clustered around Pupukea MLCD with Shark's Cove.
  {
    id: 'three-tables',
    name: "Three Tables",
    lat: 21.6483,
  ...
  // Oahu south shore — urban / leeward
  {
    id: 'magic-island',
    name: "Magic Island",
    lat: 21.2836,
  ...
  // Oahu — Pearl Harbor entrance channel
  {
    id: 'pearl-harbor',
    name: "Pearl Harbor",
    lat: 21.3650,
  ...
  // Maui south — La Perouse Bay (remote MLCD)
  {
    id: 'la-perouse',
    name: "La Perouse",
    lat: 20.5949,
